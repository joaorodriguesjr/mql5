...
[MQL5 Reference](index.md)  /  [Network Functions](network.md) / SocketIsConnected

[![Previous](previous.png)](socketconnect.md) 
[![Next](next.png)](socketisreadable.md)
...
[SocketConnect](socketconnect.md), [SocketIsWritable](socketiswritable.md), [SocketCreate](socketcreate.md), [SocketClose](socketclose.md)