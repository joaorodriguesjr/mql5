...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md)  /  [Uniform distribution](unifrom.md) / MathCumulativeDistributionUniform

[![Previous](previous.png)](mathprobabilitydensityuniform.md) 
[![Next](next.png)](mathquantileuniform.md)

MathCumulativeDistributionUniform

Calculates the probability distribution function of uniform distribution with the a and b parameters for a random variable x. In case of error it returns [NaN](double.md).
...
Calculates the probability distribution function of uniform distribution with the a and b parameters for an array of random variables x[]. In case of error it returns false. Analog of the [punif()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/Uniform.md) in R.
