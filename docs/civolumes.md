...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Volume Indicators](volumeindicators.md) / CiVolumes

[![Previous](previous.png)](ciobvtype.md) 
[![Next](next.png)](civolumesapplied.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiVolumes |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [Applied](civolumesapplied.md) | Returns the volume type to apply |
| Create Methods |  |
| [Create](civolumescreate.md) | Creates the indicator |
| Data Access Methods |  |
| [Main](civolumesmain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](civolumestype.md) | Virtual identification method |
