...
[MQL5 Reference](index.md)  /  [Technical Indicators](indicators.md) / iBands

[![Previous](previous.png)](ibearspower.md) 
[![Next](next.png)](ibullspower.md)
...
The buffer numbers are the following: 0 - BASE\_LINE, 1 - UPPER\_BAND, 2 - LOWER\_BAND
