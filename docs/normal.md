...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Normal Distribution

[![Previous](previous.png)](mathaveragedeviation.md) 
[![Next](next.png)](mathprobabilitydensitynormal.md)
...
![pdf_normal_distribution](pdf_normal_distribution.png)
...
![DemoNormalDistribution](demonormaldistribution.png)
...
| --- | --- |
| [MathProbabilityDensityNormal](mathprobabilitydensitynormal.md) | Calculates the probability density function of the normal distribution |
| [MathCumulativeDistributionNormal](mathcumulativedistributionnormal.md) | Calculates the value of the normal probability distribution function |
| [MathQuantileNormal](mathquantilenormal.md) | Calculates the value of the inverse normal distribution function for the specified probability |
| [MathRandomNormal](mathrandomnormal.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the normal law |
| [MathMomentsNormal](mathmomentsnormal.md) | Calculates the theoretical numerical values of the first 4 moments of the normal distribution |
