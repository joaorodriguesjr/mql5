...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROW\_THUMB\_DOWN

[![Previous](previous.png)](obj_arrow_thumb_up.md) 
[![Next](next.png)](obj_arrow_up.md)

OBJ\_ARROW\_THUMB\_DOWN

Thumbs Down sign.

![ObjArrowTumbDown](objarrowtumbdown.png)

Note

Anchor point position relative to the sign can be selected from [ENUM\_ARROW\_ANCHOR](enum_anchorpoint.md#enum_arrow_anchor) enumeration.

Large signs (more than 5) can only be created by setting the appropriate [OBJPROP\_WIDTH](enum_object_property.md#enum_object_property_integer) property value when writing a code in MetaEditor.
