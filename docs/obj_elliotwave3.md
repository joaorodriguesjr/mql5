...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ELLIOTWAVE3

[![Previous](previous.png)](obj_elliotwave5.md) 
[![Next](next.png)](obj_rectangle.md)

OBJ\_ELLIOTWAVE3

Elliott Correction Wave.

![ObjElliotWave3](objelliotwave3.png)

Note

For "Elliott Correction Wave", it is possible to enable/disable the mode of connecting points by lines ([OBJPROP\_DRAWLINES](enum_object_property.md#enum_object_property_integer) property), as well as set the level of wave positioning (from [ENUM\_ELLIOT\_WAVE\_DEGREE](enum_elliot_wave_degree.md) enumeration).
