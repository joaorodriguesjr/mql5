...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Base classes](cindicators.md) / COpenBuffer

[![Previous](previous.png)](cdoublebufferrefreshcurrent.md) 
[![Next](next.png)](copenbufferrefresh.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayDouble](carraydouble.md)                [CDoubleBuffer](cdoublebuffer.md)                    COpenBuffer |

Class Methods by Groups

| Data Update |  |
| --- | --- |
| virtual [Refresh](copenbufferrefresh.md) | Updates the buffer |
| virtual [RefreshCurrent](copenbufferrefreshcurrent.md) | Updates the current value |
