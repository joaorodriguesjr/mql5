...
[MQL5 Reference](index.md)  /  [Timeseries and Indicators Access](series.md) / CopyClose

[![Previous](previous.png)](copylow.md) 
[![Next](next.png)](copytickvolume.md)

CopyClose

The function gets into close\_array the history data of bar close prices for the selected symbol-period pair in the specified quantity. It should be noted that elements ordering is from present to past, i.e., starting position of 0 means the current bar.

![CopyClose](copyclose.png)
