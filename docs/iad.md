...
[MQL5 Reference](index.md)  /  [Technical Indicators](indicators.md) / iAD

[![Previous](previous.png)](iac.md) 
[![Next](next.png)](iadx.md)
...
[in]   The volume used. Can be any of [ENUM\_APPLIED\_VOLUME](prices.md#enum_applied_volume_enum) values.
