...
[MQL5 Reference](index.md)  /  [Conversion Functions](convert.md) / ShortArrayToString

[![Previous](previous.png)](shorttostring.md) 
[![Next](next.png)](timetostring.md)
...
[in]  Array of ushort type (analog of wchar\_t type).
...
[StringToShortArray](stringtoshortarray.md), [CharArrayToString](chararraytostring.md), [Use of a Codepage](codepageusage.md)