...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_LABEL

[![Previous](previous.png)](obj_text.md) 
[![Next](next.png)](obj_button.md)

OBJ\_LABEL

Label object.

![ObjTextLabel](objtextlabel.png)
...
You can also select text label anchoring corner from [ENUM\_BASE\_CORNER](enum_basecorner.md) enumeration.
