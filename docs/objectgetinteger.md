...
[MQL5 Reference](index.md)  /  [Object Functions](objects.md) / ObjectGetInteger

[![Previous](previous.png)](objectgetdouble.md) 
[![Next](next.png)](objectgetstring.md)

ObjectGetInteger

The function returns the value of the corresponding object property. The object property must be of the [datetime, int, color, bool or char](integer.md) type. There are 2 variants of the function.
...
For the second variant the function returns true, if this property is maintained and the value has been placed into the long\_var variable, otherwise returns false. To read more about the [error](errorcodes.md) call [GetLastError()](getlasterror.md).
