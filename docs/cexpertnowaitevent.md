...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Strategy Modules](expertclasses.md)  /  [Base classes for Expert Advisors](expertbaseclasses.md)  /  [CExpert](cexpert.md) / NoWaitEvent

[![Previous](previous.png)](cexpertwaitevent.md) 
[![Next](next.png)](cexperttradeeventpositionstoptake.md)
...
[in]  Flag with events (from ENUM\_TRADE\_EVENTS enumeration) to reset.
