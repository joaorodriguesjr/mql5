...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_FIBOARC

[![Previous](previous.png)](obj_fibofan.md) 
[![Next](next.png)](obj_fibochannel.md)

OBJ\_FIBOARC

Fibonacci Arcs.

![ObjFiboArc](objfiboarc.png)
