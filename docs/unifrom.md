...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Uniform distribution

[![Previous](previous.png)](mathmomentscauchy.md) 
[![Next](next.png)](mathprobabilitydensityuniform.md)
...
![pdf_uniform_distribution](pdf_uniform_distribution.png)
...
![DemoUniformDistribution](demouniformdistribution.png)
...
| --- | --- |
| [MathProbabilityDensityUniform](mathprobabilitydensityuniform.md) | Calculates the probability density function of the uniform distribution |
| [MathCumulativeDistributionUniform](mathcumulativedistributionuniform.md) | Calculates the value of the uniform probability distribution function |
| [MathQuantileUniform](mathquantileuniform.md) | Calculates the value of the inverse uniform distribution function for the specified probability |
| [MathRandomUniform](mathrandomuniform.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the uniform law |
| [MathMomentsUniform](mathmomentsuniform.md) | Calculates the theoretical numerical values of the first 4 moments of the uniform distribution |
