...
[MQL5 Reference](index.md)  /  [File Functions](files.md) / FileWriteStruct

[![Previous](previous.png)](filewritestring.md) 
[![Next](next.png)](fileload.md)
...
[in] Reference to the object of this structure. The structure should not contain strings, [dynamic arrays](dynamic_array.md) or [virtual functions](virtual.md).
