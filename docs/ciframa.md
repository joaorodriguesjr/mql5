...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiFrAMA

[![Previous](previous.png)](citematype.md) 
[![Next](next.png)](ciframamaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiFrAMA |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](ciframamaperiod.md) | Returns the averaging period |
| [IndShift](ciframaindshift.md) | Returns the horizontal shift |
| [Applied](ciframaapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](ciframacreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciframamain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](ciframatype.md) | Virtual identification method |
