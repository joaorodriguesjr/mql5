...
[MQL5 Reference](index.md)  /  [Math Functions](math.md) / MathExp

[![Previous](previous.png)](mathcos.md) 
[![Next](next.png)](mathfloor.md)
...
![MathExp_Screenshot](mathexp_screenshot.png)
