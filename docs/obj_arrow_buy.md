...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROW\_BUY

[![Previous](previous.png)](obj_arrow_right_price.md) 
[![Next](next.png)](obj_arrow_sell.md)

OBJ\_ARROW\_BUY

Buy sign.

![ObjArrowBuy](objarrowbuy.png)
