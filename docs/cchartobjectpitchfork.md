...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Channel Objects](obj_channels.md) / CChartObjectPitchfork

[![Previous](previous.png)](cchartobjectstddevchanneltype.md) 
[![Next](next.png)](cchartobjectpitchforkcreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CChartObject](cchartobject.md)            [CChartObjectTrend](cchartobjecttrend.md)                CChartObjectPitchfork |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cchartobjectpitchforkcreate.md) | Creates "Andrew's Pitchfork" graphical object |
| Input/output |  |
| virtual [Type](cchartobjectpitchforktype.md) | Virtual method of identification |
