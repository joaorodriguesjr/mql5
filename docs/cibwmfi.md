...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Bill Williams Indicators](bwindicators.md) / CiBWMFI

[![Previous](previous.png)](cigatortype.md) 
[![Next](next.png)](cibwmfiapplied.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiBWMFI |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [Applied](cibwmfiapplied.md) | Returns the volume type to apply |
| Create |  |
| [Create](cibwmficreate.md) | Creates the indicator |
| Data Access |  |
| [Main](cibwmfimain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](cibwmfitype.md) | Virtual identification method |
