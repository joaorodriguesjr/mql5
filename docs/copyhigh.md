...
[MQL5 Reference](index.md)  /  [Timeseries and Indicators Access](series.md) / CopyHigh

[![Previous](previous.png)](copyopen.md) 
[![Next](next.png)](copylow.md)

CopyHigh

The function gets into high\_array the history data of highest bar prices for the selected symbol-period pair in the specified quantity. It should be noted that elements ordering is from present to past, i.e., starting position of 0 means the current bar.

![CopyHigh](copyhigh.png)
