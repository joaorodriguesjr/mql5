...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Control Objects](obj_controls.md) / CChartObjectEdit

[![Previous](previous.png)](cchartobjectlabeltype.md) 
[![Next](next.png)](cchartobjecteditcreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CChartObject](cchartobject.md)            [CChartObjectText](cchartobjecttext.md)                [CChartObjectLabel](cchartobjectlabel.md)                    CChartObjectEdit  Direct descendants  [CChartObjectButton](cchartobjectbutton.md) |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cchartobjecteditcreate.md) | Creates "Edit" graphical object |
| Properties |  |
| [TextAlign](cchartobjectedittextalign.md) | Gets/sets "TextAlign" property |
| [X\_Size](cchartobjecteditx_size.md) | Gets "X Size" property |
| [Y\_Size](cchartobjectedity_size.md) | Gets "Y Size" property |
| [BackColor](cchartobjecteditbackcolor.md) | Gets/sets "Background Color" property |
| [BorderColor](cchartobjecteditbordercolor.md) | Gets/sets "Border Color" property |
| [ReadOnly](readonly.md) | Gets/sets "Read Only" property |
| [Angle](cchartobjecteditangle.md) | Gets/sets "Angle" property |
| Input/output |  |
| virtual [Save](cchartobjecteditsave.md) | Virtual method for writing to file |
| virtual [Load](cchartobjecteditload.md) | Virtual method for reading from file |
| virtual [Type](cchartobjectedittype.md) | Virtual method of identification |
