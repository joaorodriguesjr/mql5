...
[MQL5 Reference](index.md)  /  [Technical Indicators](indicators.md) / iFractals

[![Previous](previous.png)](iforce.md) 
[![Next](next.png)](iframa.md)
...
The buffer numbers are the following: 0 - UPPER\_LINE, 1 - LOWER\_LINE.
