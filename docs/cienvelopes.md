...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiEnvelopes

[![Previous](previous.png)](cibandstype.md) 
[![Next](next.png)](cienvelopesmaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiEnvelopes |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](cienvelopesmaperiod.md) | Returns the averaging period |
| [MaShift](cienvelopesmashift.md) | Returns the horizontal shift |
| [MaMethod](cienvelopesmamethod.md) | Returns the averaging method |
| [Deviation](cienvelopesdeviation.md) | Returns the deviation |
| [Applied](cienvelopesapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](cienvelopescreate.md) | Creates the indicator |
| Data Access |  |
| [Upper](cienvelopesupper.md) | Returns the buffer data of the upper line |
| [Lower](cienvelopeslower.md) | Returns the buffer data of the lower line |
| Input/output |  |
| virtual [Type](cienvelopestype.md) | Virtual identification method |
