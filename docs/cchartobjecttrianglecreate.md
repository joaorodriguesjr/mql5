...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Shape Objects](obj_shapes.md)  /  [CChartObjectTriangle](cchartobjecttriangle.md) / Create

[![Previous](previous.png)](cchartobjecttriangle.md) 
[![Next](next.png)](cchartobjecttriangletype.md)
