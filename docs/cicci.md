...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiCCI

[![Previous](previous.png)](cibullspowertype.md) 
[![Next](next.png)](ciccimaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiCCI |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](ciccimaperiod.md) | Returns the averaging period |
| [Applied](cicciapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](ciccicreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciccimain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](ciccitype.md) | Virtual identification method |
