...
[MQL5 Reference](index.md)  /  [Timeseries and Indicators Access](series.md) / CopyRealVolume

[![Previous](previous.png)](copytickvolume.md) 
[![Next](next.png)](copyspread.md)

CopyRealVolume

The function gets into volume\_array the history data of trade volumes for the selected symbol-period pair in the specified quantity. It should be noted that elements ordering is from present to past, i.e., starting position of 0 means the current bar.

![CopyRealVolume](copyrealvolume.png)
...
Returns the copied data count or -1 in the case of [error](errorcodes.md).
