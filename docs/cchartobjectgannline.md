...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Gann Tools](obj_gann.md) / CChartObjectGannLine

[![Previous](previous.png)](obj_gann.md) 
[![Next](next.png)](cchartobjectgannlinecreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CChartObject](cchartobject.md)            [CChartObjectTrend](cchartobjecttrend.md)                [CChartObjectTrendByAngle](cchartobjecttrendbyangle.md)                    CChartObjectGannLine |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cchartobjectgannlinecreate.md) | Creates "Gann Line" graphical objects |
| Properties |  |
| [PipsPerBar](cchartobjectgannlinepipsperbar.md) | Gets/sets "Pips per bar" property |
| Input/output |  |
| virtual [Save](cchartobjectgannlinesave.md) | Virtual method for writing to file |
| virtual [Load](cchartobjectgannlineload.md) | Virtual method for reading from file |
| virtual [Type](cchartobjectgannlinetype.md) | Virtual method of identification |
...
| Methods inherited from class CChartObjectTrendByAngle  [Angle](cchartobjecttrendbyangleangle.md), [Angle](cchartobjecttrendbyangleangle.md), [Create](cchartobjecttrendbyanglecreate.md) |
