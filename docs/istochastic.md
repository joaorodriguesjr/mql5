...
[MQL5 Reference](index.md)  /  [Technical Indicators](indicators.md) / iStochastic

[![Previous](previous.png)](istddev.md) 
[![Next](next.png)](itema.md)
...
[in]  Parameter of price selection for calculations. Can be one of the [ENUM\_STO\_PRICE](prices.md#enum_sto_price_enum) values.
...
The buffer numbers: 0 - MAIN\_LINE, 1 - SIGNAL\_LINE.
