...
[MQL5 Reference](index.md)  /  [Timeseries and Indicators Access](series.md) / iOpen

[![Previous](previous.png)](ilowest.md) 
[![Next](next.png)](itime.md)
...
The Open price of the bar (indicated by the 'shift' parameter) on the corresponding chart or 0 in case of an error. For [error](errorcodes.md) details, call the [GetLastError()](getlasterror.md) function.
...
[CopyOpen](copyopen.md), [CopyRates](copyrates.md)