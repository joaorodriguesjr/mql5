...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_FIBO

[![Previous](previous.png)](obj_ganngrid.md) 
[![Next](next.png)](obj_fibotimes.md)

OBJ\_FIBO

Fibonacci Retracement.

![ObjFiboLevels](objfibolevels.png)

Note

For Fibonacci Retracement, it is possible to specify the mode of continuation of its display to the right and/or left ([OBJPROP\_RAY\_RIGHT](enum_object_property.md#enum_object_property_integer) and [OBJPROP\_RAY\_LEFT](enum_object_property.md#enum_object_property_integer) properties accordingly).
