...
[MQL5 Reference](index.md)  /  [Working with databases](database.md) / DatabaseColumnDouble

[![Previous](previous.png)](databasecolumnlong.md) 
[![Next](next.png)](databasecolumnblob.md)
