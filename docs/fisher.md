...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / F-distribution

[![Previous](previous.png)](mathmomentsexponential.md) 
[![Next](next.png)](mathprobabilitydensityf.md)
...
![pdf_F_distribution](pdf_f_distribution.png)
...
![DemoFDistribution](demofdistribution.png)
...
| --- | --- |
| [MathProbabilityDensityF](mathprobabilitydensityf.md) | Calculates the probability density function of the F-distribution |
| [MathCumulativeDistributionF](mathcumulativedistributionf.md) | Calculates the value of the F-distribution function |
| [MathQuantileF](mathquantilef.md) | Calculates the value of the inverse F-distribution function for the specified probability |
| [MathRandomF](mathrandomf.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the Fisher's law |
| [MathMomentsF](mathmomentsf.md) | Calculates the theoretical numerical values of the first 4 moments of the Fisher's F-distribution |
