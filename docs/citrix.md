...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiTriX

[![Previous](previous.png)](cistochastictype.md) 
[![Next](next.png)](citrixmaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiTriX |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](citrixmaperiod.md) | Returns the averaging period |
| [Applied](citrixapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](citrixcreate.md) | Creates the indicator |
| Data Access |  |
| [Main](citrixmain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](citrixtype.md) | Virtual identification method |
