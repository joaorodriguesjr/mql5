...
[MQL5 Reference](index.md)  /  [Technical Indicators](indicators.md) / iMA

[![Previous](previous.png)](imfi.md) 
[![Next](next.png)](iosma.md)
...
[in]  Smoothing type. Can be one of the [ENUM\_MA\_METHOD](enum_ma_method.md) values.
