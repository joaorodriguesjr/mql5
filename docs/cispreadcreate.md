...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Timeseries classes](timeseries.md)  /  [CiSpread](cispread.md) / Create

[![Previous](previous.png)](cispread.md) 
[![Next](next.png)](cispreadbufferresize.md)
