...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Noncentral t-distribution

[![Previous](previous.png)](mathmomentst.md) 
[![Next](next.png)](mathprobabilitydensitynoncentralt.md)
...
![pdf_noncentral_T_distribution](pdf_noncentral_t_distribution.png)
...
![DemoNoncentralT](demononcentralt.png)
...
| --- | --- |
| [MathProbabilityDensityNoncentralT](mathprobabilitydensitynoncentralt.md) | Calculates the probability density function of the noncentral t-distribution |
| [MathCumulativeDistributionNoncentralT](mathcumulativedistributionnoncentralt.md) | Calculates the value of the noncentral t-distribution function |
| [MathQuantileNoncentralT](mathquantilenoncentralt.md) | Calculates the value of the inverse noncentral t-distribution function for the specified probability |
| [MathRandomNoncentralT](mathrandomnoncentralt.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the noncentral Student's t-distribution law |
| [MathMomentsNoncentralT](mathmomentsnoncentralt.md) | Calculates the theoretical numerical values of the first 4 moments of the noncentral Student's t-distribution |
