...
[MQL5 Reference](index.md)  /  [Trade Functions](trading.md) / HistoryOrderGetTicket

[![Previous](previous.png)](historyorderstotal.md) 
[![Next](next.png)](historyordergetdouble.md)

HistoryOrderGetTicket

Return the ticket of a corresponding order in the history. Prior to calling HistoryOrderGetTicket(), first it is necessary to receive the history of deals and orders using the [HistorySelect()](historyselect.md) or [HistorySelectByPosition()](historyselectbyposition.md) function.
