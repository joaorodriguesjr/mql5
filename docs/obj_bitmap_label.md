...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_BITMAP\_LABEL

[![Previous](previous.png)](obj_bitmap.md) 
[![Next](next.png)](obj_edit.md)

OBJ\_BITMAP\_LABEL

Bitmap Label object.

![ObjBitmapLabel](objbitmaplabel.png)

Note

Anchor point position relative to the label can be selected from [ENUM\_ANCHOR\_POINT](enum_anchorpoint.md) enumeration. Anchor point coordinates are set in pixels.

You can also select bitmap anchoring corner from [ENUM\_BASE\_CORNER](enum_basecorner.md) enumeration.

For bitmap label, you can select [visibility scope](enum_object_property.md#visual_rectangle) of an image.
