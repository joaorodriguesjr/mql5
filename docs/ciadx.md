...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiADX

[![Previous](previous.png)](trendindicators.md) 
[![Next](next.png)](ciadxmaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiADX |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](ciadxmaperiod.md) | Returns the averaging period |
| Create |  |
| [Create](ciadxcreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciadxmain.md) | Returns the buffer element of the main line |
| [Plus](ciadxplus.md) | Returns the buffer element of the +DI line |
| [Minus](ciadxminus.md) | Returns the buffer element of the -DI line |
| Input/output |  |
| virtual [Type](ciadxtype.md) | Virtual identification method |
