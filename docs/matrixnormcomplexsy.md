...
[MQL5 Reference](index.md)  /  [Matrix and Vector Methods](matrix.md)  /  [OpenBLAS](openblas.md)  /  [Matrix Norm](blas_matrix_norm.md) / MatrixNormComplexSy

[![Previous](previous.png)](matrixnormsy.md) 
[![Next](next.png)](matrixnormsytrid.md)

MatrixNormComplexSy

Returns the value of the 1-norm, infinity-norm, Frobenius norm, or the largest absolute value of any element of a complex symmetric (not Hermitian) matrix. LAPACK function [LANSY](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/lansy.md).
