...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_CYCLES

[![Previous](previous.png)](obj_trendbyangle.md) 
[![Next](next.png)](obj_arrowed_line.md)

OBJ\_CYCLES

Cycle Lines.

![ObjCycles](objcycles.png)
