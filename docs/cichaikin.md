...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiChaikin

[![Previous](previous.png)](ciccitype.md) 
[![Next](next.png)](cichaikinfastmaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiChaikin |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [FastMaPeriod](cichaikinfastmaperiod.md) | Returns the averaging period for the fast MA |
| [SlowMaPeriod](cichaikinslowmaperiod.md) | Returns the averaging period for the slow MA |
| [MaMethod](cichaikinmamethod.md) | Returns the averaging method |
| [Applied](cichaikinapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](cichaikincreate.md) | Creates the indicator |
| Data Access |  |
| [Main](cichaikinmain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](cichaikintype.md) | Virtual identification method |
