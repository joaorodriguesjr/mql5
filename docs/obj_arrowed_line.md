...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROWED\_LINE

[![Previous](previous.png)](obj_cycles.md) 
[![Next](next.png)](obj_channel.md)

OBJ\_ARROWED\_LINE

Arrowed line.

![ObjArrowedLine](objarrowedline.png)
