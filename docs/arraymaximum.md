...
[MQL5 Reference](index.md)  /  [Array Functions](array.md) / ArrayMaximum

[![Previous](previous.png)](arrayisseries.md) 
[![Next](next.png)](arrayminimum.md)
...
The [AS\_SERIES](arraygetasseries.md) flag value is taken into account while searching for a maximum.
