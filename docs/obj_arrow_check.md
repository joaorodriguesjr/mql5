...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROW\_CHECK

[![Previous](previous.png)](obj_arrow_stop.md) 
[![Next](next.png)](obj_arrow_left_price.md)

OBJ\_ARROW\_CHECK

Check sign.

![ObjArrowCheck](objarrowcheck.png)
