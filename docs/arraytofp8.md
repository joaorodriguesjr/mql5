...
[MQL5 Reference](index.md)  /  [Array Functions](array.md) / ArrayToFP8

[![Previous](previous.png)](arraytofp16.md) 
[![Next](next.png)](arrayfromfp16.md)

ArrayToFP8

Copies an array of type float or double into an array of type [uchar](integertypes.md#uchar) with the given format.
...
The function converts input parameters of type float or double into one of FP8 types. These input parameters are then used in the [OnnxRun](onnxrun.md) function.
...
[ArrayFromFP8](arrayfromfp8.md), [ArrayCopy](arraycopy.md)