...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiTEMA

[![Previous](previous.png)](cidematype.md) 
[![Next](next.png)](citemamaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiTEMA |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](citemamaperiod.md) | Returns the averaging period |
| [IndShift](citemaindshift.md) | Returns the horizontal shift |
| [Applied](citemaapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](citemacreate.md) | Creates the indicator |
| Data Access |  |
| [Main](citemamain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](citematype.md) | Virtual identification method |
