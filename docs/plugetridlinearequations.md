...
[MQL5 Reference](index.md)  /  [Matrix and Vector Methods](matrix.md)  /  [OpenBLAS](openblas.md)  /  [Factored Calculations](factored_calculations.md) / PLUGeTridLinearEquationsSolution

[![Previous](previous.png)](pluqlinearequationssolution.md) 
[![Next](next.png)](plugetridcondnumreciprocal.md)
...
with a tridiagonal matrix A using the LU-factorization computed by [FactorizationPLUGeTridRaw](factorizationplugetridraw.md), with multiple right-hand sides. LAPACK function [GTTRS](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/gttrs.md).
