...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Bill Williams Indicators](bwindicators.md) / CiAO

[![Previous](previous.png)](cialligatortype.md) 
[![Next](next.png)](ciaocreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiAO |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](ciaocreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciaomain.md) | Returns the buffer element |
| Input/output |  |
| virtual [Type](ciaotype.md) | Virtual identification method |
