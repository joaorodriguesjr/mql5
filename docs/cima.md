...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiMA

[![Previous](previous.png)](ciichimokutype.md) 
[![Next](next.png)](cimamaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiMA |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](cimamaperiod.md) | Returns the averaging period |
| [MaShift](cimamashift.md) | Returns the horizontal shift |
| [MaMethod](cimamamethod.md) | Returns the averaging method |
| [Applied](cimaapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](cimacreate.md) | Creates the indicator |
| Data Access |  |
| [Main](cimamain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](cimatype.md) | Virtual identification method |
