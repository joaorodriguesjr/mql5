...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Geometric distribution

[![Previous](previous.png)](mathmomentsmegativebinomial.md) 
[![Next](next.png)](mathprobabilitydensitygeometric.md)
...
![pdf_geometric_distribution](pdf_geometric_distribution.png)
...
![DemoGeometricDistribution](demogeometricdistribution.png)
...
| --- | --- |
| [MathProbabilityDensityGeometric](mathprobabilitydensitygeometric.md) | Calculates the probability density function of the geometric distribution |
| [MathCumulativeDistributionGeometric](mathcumulativedistributiongeometric.md) | Calculates the value of the geometric probability distribution function |
| [MathQuantileGeometric](mathquantilegeometric.md) | Calculates the value of the inverse geometric distribution function for the specified probability |
| [MathRandomGeometric](mathrandomgeometric.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the geometric law |
| [MathMomentsGeometric](mathmomentsgeometric.md) | Calculates the theoretical numerical values of the first 4 moments of the geometric distribution |
