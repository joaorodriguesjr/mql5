...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / T-distribution

[![Previous](previous.png)](mathmomentsnoncentralf.md) 
[![Next](next.png)](mathprobabilitydensityt.md)
...
![pdf_T_distribution](pdf_t_distribution.png)
...
![DemoTDistribution](demotdistribution.png)
...
| --- | --- |
| [MathProbabilityDensityT](mathprobabilitydensityt.md) | Calculates the probability density function of the t-distribution |
| [MathCumulativeDistributionT](mathcumulativedistributiont.md) | Calculates the value of the t-distribution function |
| [MathQuantileT](mathquantilet.md) | Calculates the value of the inverse t-distribution function for the specified probability |
| [MathRandomT](mathrandomt.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the law of Student's t-distribution |
| [MathMomentsT](mathmomentst.md) | Calculates the theoretical numerical values of the first 4 moments of the Student's t-distribution |
