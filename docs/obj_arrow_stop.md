...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROW\_STOP

[![Previous](previous.png)](obj_arrow_down.md) 
[![Next](next.png)](obj_arrow_check.md)

OBJ\_ARROW\_STOP

Stop sign.

![ObjArrowStop](objarrowstop.png)
