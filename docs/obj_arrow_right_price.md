...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROW\_RIGHT\_PRICE

[![Previous](previous.png)](obj_arrow_left_price.md) 
[![Next](next.png)](obj_arrow_buy.md)

OBJ\_ARROW\_RIGHT\_PRICE

Right Price Label.

![ObjArrowRightPrice](objarrowrightprice.png)
