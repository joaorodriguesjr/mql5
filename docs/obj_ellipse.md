...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ELLIPSE

[![Previous](previous.png)](obj_triangle.md) 
[![Next](next.png)](obj_arrow_thumb_up.md)

OBJ\_ELLIPSE

Ellipse.

![ObjEllipse](objellipse.png)

Note

For ellipse, the mode of filling with color can be set using [OBJPROP\_FILL](enum_object_property.md#enum_object_property_integer) property.
