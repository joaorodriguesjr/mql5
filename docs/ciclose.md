...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Timeseries classes](timeseries.md) / CiClose

[![Previous](previous.png)](cilowgetdata.md) 
[![Next](next.png)](ciclosecreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CPriceSeries](cpriceseries.md)                        CiClose |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](ciclosecreate.md) | Creates a series |
| Data Access |  |
| [GetData](ciclosegetdata.md) | Gets series data |
