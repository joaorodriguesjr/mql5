...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiADXWilder

[![Previous](previous.png)](ciadxtype.md) 
[![Next](next.png)](ciadxwildermaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiADXWilder |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](ciadxwildermaperiod.md) | Returns the averaging period |
| Create |  |
| [Create](ciadxwildercreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciadxwildermain.md) | Returns the buffer data of the main line |
| [Plus](ciadxwilderplus.md) | Returns the buffer data of the +DI line |
| [Minus](ciadxwilderminus.md) | Returns the buffer data of the -DI line |
| Input/output |  |
| virtual [Type](ciadxwildertype.md) | Virtual identification method |
