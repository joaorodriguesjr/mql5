...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Panels and Dialogs](controls.md)  /  [CWndClient](cwndclient.md) / Create

[![Previous](previous.png)](cwndclient.md) 
[![Next](next.png)](cwndclientonevent.md)
