...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md)  /  [Gamma distribution](gamma.md) / MathQuantileGamma

[![Previous](previous.png)](mathcumulativedistributiongamma.md) 
[![Next](next.png)](mathrandomgamma.md)

MathQuantileGamma

For the specified probability, the function calculates the value of inverse gamma distribution function with the a and b parameters. In case of error it returns [NaN](double.md).
...
For the specified probability[] array of probability values, the function calculates the value of inverse gamma distribution function with the a and b parameters. In case of error it returns false. Analog of the [qgamma()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/GammaDist.md) in R.
