...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Control Objects](obj_controls.md)  /  [CChartObjectBitmap](cchartobjectbitmap.md) / X\_Offset

[![Previous](previous.png)](cchartobjectbitmapbmpfile.md) 
[![Next](next.png)](cchartobjectbitmapy_offset.md)

X\_Offset (Get Method)

Gets the value of "X\_Offset" property (the upper left corner) of the [CChartObjectBitmap](cchartobjectbitmap.md) graphical object.
