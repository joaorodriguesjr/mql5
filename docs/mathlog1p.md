...
[MQL5 Reference](index.md)  /  [Math Functions](math.md) / MathLog1p

[![Previous](previous.png)](mathexpm1.md) 
[![Next](next.png)](matharccosh.md)
...
![MathLog1p_Screenshot](mathlog1p_screenshot.png)
