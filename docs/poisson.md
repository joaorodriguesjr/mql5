...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Poisson distribution

[![Previous](previous.png)](mathmomentshypergeometric.md) 
[![Next](next.png)](mathprobabilitydensitypoisson.md)
...
![pdf_poisson_distribution](pdf_poisson_distribution.png)
...
![DemoPoissonDistribution](demopoissondistribution.png)
...
| --- | --- |
| [MathProbabilityDensityPoisson](mathprobabilitydensitypoisson.md) | Calculates the probability density function of the Poisson distribution |
| [MathCumulativeDistributionPoisson](mathcumulativedistributionpoisson.md) | Calculates the value of the Poisson probability distribution function |
| [MathQuantilePoisson](mathquantilepoisson.md) | Calculates the value of the inverse Poisson distribution function for the specified probability |
| [MathRandomPoisson](mathrandompoisson.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the Poisson law |
| [MathMomentsPoisson](mathmomentspoisson.md) | Calculates the theoretical numerical values of the first 4 moments of the Poisson distribution |
