...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiRVI

[![Previous](previous.png)](cirsitype.md) 
[![Next](next.png)](cirvimaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiRVI |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](cirvimaperiod.md) | Returns the averaging period |
| Create Methods |  |
| [Create](cirvicreate.md) | Creates the indicator |
| Data Access Methods |  |
| [Main](cirvimain.md) | Returns the buffer data of the main line |
| [Signal](cirvisignal.md) | Returns the buffer data of the signal line |
| Input/output |  |
| virtual [Type](cirvitype.md) | Virtual identification method |
