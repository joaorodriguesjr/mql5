...
[MQL5 Reference](index.md)  /  [Market Info](marketinformation.md) / SymbolInfoInteger

[![Previous](previous.png)](symbolinfodouble.md) 
[![Next](next.png)](symbolinfostring.md)
...
[in] Identifier of a symbol property. The value can be one of the values of the [ENUM\_SYMBOL\_INFO\_INTEGER](marketinfoconstants.md#enum_symbol_info_integer) enumeration.
...
The value of long type. In case of execution failure, information about the [error](errorcodes.md) can be obtained using [GetLastError()](getlasterror.md) function:
