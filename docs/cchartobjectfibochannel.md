...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Fibonacci Tools](obj_fibonacci.md) / CChartObjectFiboChannel

[![Previous](previous.png)](cchartobjectfiboarctype.md) 
[![Next](next.png)](cchartobjectfibochannelcreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CChartObject](cchartobject.md)            [CChartObjectTrend](cchartobjecttrend.md)                CChartObjectFiboChannel |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cchartobjectfibochannelcreate.md) | Creates "Fibonacci Channel" graphical object |
| Input/output |  |
| virtual [Type](cchartobjectfibochanneltype.md) | Virtual method of identification |
