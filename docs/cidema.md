...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiDEMA

[![Previous](previous.png)](cistddevtype.md) 
[![Next](next.png)](cidemamaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiDEMA |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](cidemamaperiod.md) | Returns the averaging period |
| [IndShift](cidemaindshift.md) | Returns the horizontal shift |
| [Applied](cidemaapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](cidemacreate.md) | Creates the indicator |
| Data Access |  |
| [Main](cidemamain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](cidematype.md) | Virtual identification method |
