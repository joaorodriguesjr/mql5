...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Trend Indicators](trendindicators.md) / CiVIDyA

[![Previous](previous.png)](ciamatype.md) 
[![Next](next.png)](cividyacmoperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiVIDyA |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [CmoPeriod](cividyacmoperiod.md) | Returns the period for Momentum |
| [EmaPeriod](cividyaemaperiod.md) | Returns the averaging period |
| [IndShift](cividyaindshift.md) | Returns the horizontal shift |
| [Applied](cividyaapplied.md) | Returns the price type or handle to apply |
| Create Methods |  |
| [Create](cividyacreate.md) | Creates the indicator |
| Data Access Methods |  |
| [Main](cividyamain.md) | Returns the buffer element |
| Input/output |  |
| virtual [Type](cividyatype.md) | Virtual identification method |
