...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiWPR

[![Previous](previous.png)](citrixtype.md) 
[![Next](next.png)](ciwprcalcperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiWPR |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [CalcPeriod](ciwprcalcperiod.md) | Returns the calculation period |
| Create |  |
| [Create](ciwprcreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciwprmain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](ciwprtype.md) | Virtual identification method |
