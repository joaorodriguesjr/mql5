...
[MQL5 Reference](index.md)  /  [Technical Indicators](indicators.md) / iADXWilder

[![Previous](previous.png)](iadx.md) 
[![Next](next.png)](ialligator.md)
...
The buffer numbers are the following: 0 - MAIN\_LINE, 1 - PLUSDI\_LINE, 2 - MINUSDI\_LINE.
