...
[MQL5 Reference](index.md)  /  [Matrix and Vector Methods](matrix.md)  /  [OpenBLAS](openblas.md)  /  [Eigen Values](eigen_values.md)  /  [General Matrices](general_matrices.md) / EigenSolver2SchurBlocked

[![Previous](previous.png)](eigensolver2blocked.md) 
[![Next](next.png)](eigenhessenbergschurq.md)

EigenSolver2SchurBlocked

Compute a pair of regular square matrices of generalized eigenvalues,  generalized eigenvectors, generalized Schur forms, as well as left and right Schur vectors (LAPACK function [GGES3](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/gges3.md)).
