...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Logistic distribution

[![Previous](previous.png)](mathmomentsnoncentralt.md) 
[![Next](next.png)](mathprobabilitydensitylogistic.md)
...
![pdf_logistic_distribution](pdf_logistic_distribution.png)
...
![DemoLogisticDistribution](demologisticdistribution.png)
...
| --- | --- |
| [MathProbabilityDensityLogistic](mathprobabilitydensitylogistic.md) | Calculates the probability density function of the logistic distribution |
| [MathCumulativeDistributionLogistic](mathcumulativedistributionlogistic.md) | Calculates the value of the logistic probability distribution function |
| [MathQuantileLogistic](mathquantilelogistic.md) | Calculates the value of the inverse logistic distribution function for the specified probability |
| [MathRandomLogistic](mathrandomlogistic.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the logistic law |
| [MathMomentsLogistic](mathmomentslogistic.md) | Calculates the theoretical numerical values of the first 4 moments of the logistic distribution |
