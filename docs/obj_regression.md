...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_REGRESSION

[![Previous](previous.png)](obj_stddevchannel.md) 
[![Next](next.png)](obj_pitchfork.md)

OBJ\_REGRESSION

Linear Regression Channel.

![ObjRegression](objregression.png)
