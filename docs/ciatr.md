...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiATR

[![Previous](previous.png)](oscillatorindicators.md) 
[![Next](next.png)](ciatrmaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiATR |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](ciatrmaperiod.md) | Returns the averaging period |
| Create |  |
| [Create](ciatrcreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciatrmain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](ciatrtype.md) | Virtual identification method |
