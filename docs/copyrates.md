...
[MQL5 Reference](index.md)  /  [Timeseries and Indicators Access](series.md) / CopyRates

[![Previous](previous.png)](copybuffer.md) 
[![Next](next.png)](copyseries.md)

CopyRates

Gets history data of [MqlRates](mqlrates.md) structure of a specified symbol-period in specified quantity into the rates\_array array. The elements ordering of the copied data is from present to the past, i.e., starting position of 0 means the current bar.

![CopyRates](copyrates.png)
...
[out]  Array of [MqlRates](mqlrates.md) type.

Return Value

Returns the number of copied elements or -1 in case of  an [error](errorcodes.md).
...
[Structures and Classes](classes.md), [TimeToString](timetostring.md), [StringFormat](stringformat.md)