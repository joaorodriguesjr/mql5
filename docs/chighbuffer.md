...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Base classes](cindicators.md) / CHighBuffer

[![Previous](previous.png)](copenbufferrefreshcurrent.md) 
[![Next](next.png)](chighbufferrefresh.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayDouble](carraydouble.md)                [CDoubleBuffer](cdoublebuffer.md)                    CHighBuffer |

Class Methods by Groups

| Data Update |  |
| --- | --- |
| virtual [Refresh](chighbufferrefresh.md) | Updates the buffer |
| virtual [RefreshCurrent](chighbufferrefreshcurrent.md) | Updates the current value |
