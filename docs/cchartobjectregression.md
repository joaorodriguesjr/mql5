...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Channel Objects](obj_channels.md) / CChartObjectRegression

[![Previous](previous.png)](cchartobjectchanneltype.md) 
[![Next](next.png)](cchartobjectregressioncreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CChartObject](cchartobject.md)            [CChartObjectTrend](cchartobjecttrend.md)                CChartObjectRegression |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cchartobjectregressioncreate.md) | Creates "Linear Regression Channel" graphical object |
| Input/output |  |
| virtual [Type](cchartobjectregressiontype.md) | Virtual method of identification |
