...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiDeMarker

[![Previous](previous.png)](cichaikintype.md) 
[![Next](next.png)](cidemarkermaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiDeMarker |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](cidemarkermaperiod.md) | Returns the averaging period |
| Create |  |
| [Create](cidemarkercreate.md) | Creates the indicator |
| Data Access |  |
| [Main](cidemarkermain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](cidemarkertype.md) | Virtual identification method |
