...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_TEXT

[![Previous](previous.png)](obj_arrow.md) 
[![Next](next.png)](obj_label.md)
...
Anchor point position relative to the text can be selected from [ENUM\_ANCHOR\_POINT](enum_anchorpoint.md) enumeration. You can also change text slope angle using [OBJPROP\_ANGLE](enum_object_property.md#enum_object_property_double) property.
