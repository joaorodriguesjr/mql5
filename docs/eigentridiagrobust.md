...
[MQL5 Reference](index.md)  /  [Matrix and Vector Methods](matrix.md)  /  [OpenBLAS](openblas.md)  /  [Eigen Values](eigen_values.md)  /  [Tridiagonal Matrices](tridiagonalmatrices.md) / EigenTridiagonalRobust

[![Previous](previous.png)](eigentridiagqr.md) 
[![Next](next.png)](eigentridiagbisect.md)

EigenTridiagonalRobust

Compute eigenvalues and eigenvectors of a symmetric tridiagonal matrix using the Multiple Relatively Robust Representations, MRRR algorithm (LAPACK function [STEVR](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/stevr.md)).
