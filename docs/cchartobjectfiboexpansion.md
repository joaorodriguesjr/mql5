...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Fibonacci Tools](obj_fibonacci.md) / CChartObjectFiboExpansion

[![Previous](previous.png)](cchartobjectfibochanneltype.md) 
[![Next](next.png)](cchartobjectfiboexpansioncreat.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CChartObject](cchartobject.md)            [CChartObjectTrend](cchartobjecttrend.md)                CChartObjectFiboExpansion |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cchartobjectfiboexpansioncreat.md) | Creates "Fibonacci Expansion" graphical object |
| Input/output |  |
| virtual [Type](cchartobjectfiboexpansiontype.md) | Virtual method of identification |
