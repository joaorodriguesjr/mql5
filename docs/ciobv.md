...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Volume Indicators](volumeindicators.md) / CiOBV

[![Previous](previous.png)](cimfitype.md) 
[![Next](next.png)](ciobvapplied.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiOBV |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [Applied](ciobvapplied.md) | Returns the volume type to apply |
| Create |  |
| [Create](ciobvcreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciobvmain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](ciobvtype.md) | Virtual identification method |
