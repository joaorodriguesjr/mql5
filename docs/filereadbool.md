...
[MQL5 Reference](index.md)  /  [File Functions](files.md) / FileReadBool

[![Previous](previous.png)](filereadarray.md) 
[![Next](next.png)](filereaddatetime.md)
...
[Type bool](boolconst.md), [FileWrite](filewrite.md)