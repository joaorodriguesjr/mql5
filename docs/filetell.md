...
[MQL5 Reference](index.md)  /  [File Functions](files.md) / FileTell

[![Previous](previous.png)](filesize.md) 
[![Next](next.png)](filewrite.md)
...
To obtain information about the [error](filetell.md) call [GetLastError()](getlasterror.md).
