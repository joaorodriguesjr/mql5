...
[MQL5 Reference](index.md)  /  [Network Functions](network.md) / SocketConnect

[![Previous](previous.png)](socketclose.md) 
[![Next](next.png)](socketisconnected.md)
...
If connection fails, error 5272 (ERR\_NETSOCKET\_CANNOT\_CONNECT) is written to [\_LastError](_lasterror.md).
