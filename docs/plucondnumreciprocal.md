...
[MQL5 Reference](index.md)  /  [Matrix and Vector Methods](matrix.md)  /  [OpenBLAS](openblas.md)  /  [Factored Calculations](factored_calculations.md) / PLUCondNumReciprocal

[![Previous](previous.png)](pluinverse.md) 
[![Next](next.png)](pluqlinearequationssolution.md)
...
[in]  Matrix norm value. If norm = 'O', the one-norm of the original matrix A. If norm = 'I', the infinity-norm of the original matrix A. Norm value can be obtained with [MatrixNorm](matrixnormge.md) of the original matrix A.
