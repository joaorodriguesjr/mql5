...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiForce

[![Previous](previous.png)](cidemarkertype.md) 
[![Next](next.png)](ciforcemaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiForce |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](ciforcemaperiod.md) | Returns the averaging period |
| [MaMethod](ciforcemamethod.md) | Returns the averaging method |
| [Applied](ciforceapplied.md) | Returns the object (volume type) to apply |
| Create |  |
| [Create](ciforcecreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciforcemain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](ciforcetype.md) | Virtual identification method |
