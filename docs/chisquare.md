...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Chi-squared distribution

[![Previous](previous.png)](mathmomentsgamma.md) 
[![Next](next.png)](mathprobabilitydensitychisquare.md)
...
![pdf_chi_square_distribution](pdf_chi_square_distribution.png)
...
![DemoChiSquareDistribution](demochisquaredistribution.png)
...
| --- | --- |
| [MathProbabilityDensityChiSquare](mathprobabilitydensitychisquare.md) | Calculates the probability density function of the chi-squared distribution |
| [MathCumulativeDistributionChiSquare](mathcumulativedistributionchisquare.md) | Calculates the value of the chi-squared probability distribution function |
| [MathQuantileChiSquare](mathquantilechisquare.md) | Calculates the value of the inverse chi-squared distribution function for the specified probability |
| [MathRandomChiSquare](mathrandomchisquare.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the chi-squared distribution law |
| [MathMomentsChiSquare](mathmomentschisquare.md) | Calculates the theoretical numerical values of the first 4 moments of the chi-squared distribution |
