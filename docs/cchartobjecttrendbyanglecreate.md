...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Line Objects](obj_lines.md)  /  [CChartObjectTrendByAngle](cchartobjecttrendbyangle.md) / Create

[![Previous](previous.png)](cchartobjecttrendbyangle.md) 
[![Next](next.png)](cchartobjecttrendbyangleangle.md)
