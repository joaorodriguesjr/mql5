...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Timeseries classes](timeseries.md) / CiOpen

[![Previous](previous.png)](cirealvolumerefresh.md) 
[![Next](next.png)](ciopencreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CPriceSeries](cpriceseries.md)                        CiOpen |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](ciopencreate.md) | Creates a series |
| Data Access |  |
| [GetData](ciopengetdata.md) | Gets the series data |
...
| Methods inherited from class CPriceSeries  [BufferResize](cpriceseriesbufferresize.md), [MinIndex](cpriceseriesminindex.md), [MinValue](cpriceseriesminvalue.md), [MaxIndex](cpriceseriesmaxindex.md), [MaxValue](cpriceseriesmaxvalue.md), [GetData](cpriceseriesgetdata.md), [Refresh](cpriceseriesrefresh.md) |