...
[MQL5 Reference](index.md)  /  [Network Functions](network.md) / SocketSend

[![Previous](previous.png)](socketread.md) 
[![Next](next.png)](sockettlshandshake.md)
...
[in]  Reference to the [uchar](integertypes.md) type array with the data to be sent to the socket.
