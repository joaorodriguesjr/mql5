...
[MQL5 Reference](index.md)  /  [Network Functions](network.md) / SocketRead

[![Previous](previous.png)](sockettimeouts.md) 
[![Next](next.png)](socketsend.md)
...
[in]  Number of bytes to read to the buffer[] array. Data not fitting into the array remain in the socket. They can be received by the next SocketRead call. buffer\_maxlen cannot exceed [INT\_MAX](typeconstants.md) (2147483647).
