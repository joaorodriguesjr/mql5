...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Volume Indicators](volumeindicators.md) / CiAD

[![Previous](previous.png)](volumeindicators.md) 
[![Next](next.png)](ciadapplied.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiAD |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [Applied](ciadapplied.md) | Returns the calculation period |
| Create |  |
| [Create](ciadcreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciadmain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](ciadtype.md) | Virtual identification method |
