...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Bill Williams Indicators](bwindicators.md) / CiFractals

[![Previous](previous.png)](ciaotype.md) 
[![Next](next.png)](cifractalscreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiFractals |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cifractalscreate.md) | Creates the indicator |
| Data Access |  |
| [Upper](cifractalsupper.md) | Returns the data of the upper buffer |
| [Lower](cifractalslower.md) | Returns the data of the lower buffer |
| Input/output |  |
| virtual [Type](cifractalstype.md) | Virtual identification method |
