...
[MQL5 Reference](index.md)  /  [Math Functions](math.md) / MathCosh

[![Previous](previous.png)](matharctanh.md) 
[![Next](next.png)](mathsinh.md)
...
![MathArccosh_Screenshot](matharccosh_screenshot.png)
