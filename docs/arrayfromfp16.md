...
[MQL5 Reference](index.md)  /  [Array Functions](array.md) / ArrayFromFP16

[![Previous](previous.png)](arraytofp8.md) 
[![Next](next.png)](arrayfromfp8.md)

ArrayFromFP16

Copies an array of type [ushort](integertypes.md#ushort) into an array of float or double type with the given format.
...
If the output parameters obtained from the [OnnxRun](onnxrun.md) function execution are of type FLOAT16 and BFLOAT16, you can use this function to convert the result to float or double arrays.
...
[ArrayToFP16](arraytofp16.md), [ArrayCopy](arraycopy.md)