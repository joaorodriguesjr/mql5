...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Graphic Objects](chart_object_classes.md)  /  [Gann Tools](obj_gann.md) / CChartObjectGannFan

[![Previous](previous.png)](cchartobjectgannlinetype.md) 
[![Next](next.png)](cchartobjectgannfancreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CChartObject](cchartobject.md)            [CChartObjectTrend](cchartobjecttrend.md)                CChartObjectGannFan |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cchartobjectgannfancreate.md) | Creates "Gann Fan" graphical object |
| Properties |  |
| [PipsPerBar](cchartobjectgannfanpipsperbar.md) | Gets/sets "Pips per bar" property |
| [Downtrend](cchartobjectgannfandowntrend.md) | Gets/sets "Downtrend" property |
| Input/output |  |
| virtual [Save](cchartobjectgannfansave.md) | Virtual method for writing to file |
| virtual [Load](cchartobjectgannfanload.md) | Virtual method for reading from file |
| virtual [Type](cchartobjectgannfantype.md) | Virtual method of identification |
