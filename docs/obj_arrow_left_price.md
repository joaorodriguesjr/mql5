...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROW\_LEFT\_PRICE

[![Previous](previous.png)](obj_arrow_check.md) 
[![Next](next.png)](obj_arrow_right_price.md)

OBJ\_ARROW\_LEFT\_PRICE

Left Price Label

![ObjArrowLeftPrice](objarrowleftprice.png)
