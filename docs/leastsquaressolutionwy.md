...
[MQL5 Reference](index.md)  /  [Matrix and Vector Methods](matrix.md)  /  [OpenBLAS](openblas.md)  /  [Least Squares](least_squares.md) / LeastSquaresSolutionWY

[![Previous](previous.png)](leastsquaressolutionsvd.md) 
[![Next](next.png)](leastsquaressolutionqrpivot.md)
...
LAPACK function [GELST](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/gelst.md).
