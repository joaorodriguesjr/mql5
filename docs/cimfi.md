...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Volume Indicators](volumeindicators.md) / CiMFI

[![Previous](previous.png)](ciadtype.md) 
[![Next](next.png)](cimfimaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiMFI |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](cimfimaperiod.md) | Returns the averaging period |
| [Applied](cimfiapplied.md) | Returns the volume type to apply |
| Create |  |
| [Create](cimficreate.md) | Creates the indicator |
| Data Access |  |
| [Main](cimfimain.md) | Returns the buffer data |
| Input/output |  |
| virtual [Type](cimfitype.md) | Virtual identification method |
