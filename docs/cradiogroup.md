...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Panels and Dialogs](controls.md) / CRadioGroup

[![Previous](previous.png)](cradiobuttononclicklabel.md) 
[![Next](next.png)](cradiogroupcreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CWnd](cwnd.md)            [CWndContainer](cwndcontainer.md)                [CWndClient](cwndclient.md)                    CRadioGroup |

Result of the [code](cradiogroup.md#sample) provided below:

![ControlsRadioGroup](controlsradiogroup.png)

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cradiogroupcreate.md) | Creates control |
| Chart event handlers |  |
| [OnEvent](cradiogrouponevent.md) | Event handler of all chart events |
| Add |  |
| [AddItem](cradiogroupadditem.md) | Adds new item |
| Read-only data |  |
| [Value](cradiogroupvalue.md) | Gets the value associated with the control |
| Dependent controls |  |
| [CreateButton](cradiogroupcreatebutton.md) | Creates new CRadioButton item at a specified index |
| Dependent controls event handlers |  |
| [OnVScrollShow](cradiogrouponvscrollshow.md) | "Show" internal event handler (virtual) of VScroll dependent control |
| [OnVScrollHide](cradiogrouponvscrollhide.md) | "Hide" internal event handler (virtual) of VScroll dependent control |
| [OnScrollLineDown](cradiogrouponscrolllinedown.md) | "ScrollLineDown" internal  event handler (virtual) of VScroll  dependent control |
| [OnScrollLineUp](cradiogrouponscrolllineup.md) | "ScrollLineUp" internal event handler (virtual) of VScroll dependent control |
| [OnChangeItem](cradiogrouponchangeitem.md) | "ChangeItem" internal event handler (virtual) |
| Redraw |  |
| [Redraw](cradiogroupredraw.md) | Redraws the group of items |
| [RowState](cradiogrouprowstate.md) | Sets the state of the specified item |
| [Select](cradiogroupselect.md) | Selects the current item |
