...
[MQL5 Reference](index.md)  /  [Math Functions](math.md) / MathArctanh

[![Previous](previous.png)](matharcsinh.md) 
[![Next](next.png)](mathcosh.md)
...
![MathArctanh_Screenshot](matharctanh_screenshot.png)

 

See also

[Statistics](stat.md), [Scientific Charts](graphics.md), [Client Terminal Properties](terminalstatus.md)