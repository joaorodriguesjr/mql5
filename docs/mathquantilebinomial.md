...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md)  /  [Binomial distribution](binomial.md) / MathQuantileBinomial

[![Previous](previous.png)](mathcumulativedistributionbinomial.md) 
[![Next](next.png)](mathrandombinomial.md)

MathQuantileBinomial

For the specified probability, the function calculates the inverse value of distribution function for binomial law with the n and p parameters. In case of error it returns [NaN](double.md).
...
For the specified probability[] array of probability values, the function calculates the inverse value of distribution function for binomial law with the n and p parameters. In case of error it returns false. Analog of the [qbinom()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/Binomial.md) in R.
