...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_RECTANGLE

[![Previous](previous.png)](obj_elliotwave3.md) 
[![Next](next.png)](obj_triangle.md)

OBJ\_RECTANGLE

Rectangle.

![ObjRectangle](objrectangle.png)

Note

For rectangle, the mode of filling with color can be set using [OBJPROP\_FILL](enum_object_property.md#enum_object_property_integer) property.
