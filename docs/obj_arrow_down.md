...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_ARROW\_DOWN

[![Previous](previous.png)](obj_arrow_up.md) 
[![Next](next.png)](obj_arrow_stop.md)

OBJ\_ARROW\_DOWN

Arrow Down sign.

![ObjArrowDown](objarrowdown.png)
