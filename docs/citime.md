...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Timeseries classes](timeseries.md) / CiTime

[![Previous](previous.png)](cispreadrefresh.md) 
[![Next](next.png)](citimecreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    CiTime |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](citimecreate.md) | Creates a timeseries |
| [BufferResize](citimebufferresize.md) | Sets timeseries buffer size |
| Data Access |  |
| [GetData](citimegetdata.md) | Gets the timeseries data |
| Data Update |  |
| [Refresh](citimerefresh.md) | Updates the timeseries data |
