...
[MQL5 Reference](index.md)  /  [Constants, Enumerations and Structures](constants.md)  /  [Objects Constants](objectconstants.md)  /  [Object Types](enum_object.md) / OBJ\_TRIANGLE

[![Previous](previous.png)](obj_rectangle.md) 
[![Next](next.png)](obj_ellipse.md)

OBJ\_TRIANGLE

Triangle.

![ObjTriangle](objtriangle.png)

Note

For triangle, the mode of filling with color can be set using [OBJPROP\_FILL](enum_object_property.md#enum_object_property_integer) property.
