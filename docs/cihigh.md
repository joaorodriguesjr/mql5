...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Timeseries classes](timeseries.md) / CiHigh

[![Previous](previous.png)](ciopengetdata.md) 
[![Next](next.png)](cihighcreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CPriceSeries](cpriceseries.md)                        CiHigh |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](cihighcreate.md) | Creates a series |
| Data Access |  |
| [GetData](cihighgetdata.md) | Gets the series data |
