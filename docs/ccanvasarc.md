...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Custom Graphics](canvasgraphics.md)  /  [CCanvas](ccanvas.md) / Arc

[![Previous](previous.png)](ccanvasattach.md) 
[![Next](next.png)](ccanvaspie.md)
...
[in]  Color in ARGB format. Use the [ColorToARGB()](colortoargb.md) function to convert a color into the ARGB format.
