...
[MQL5 Reference](index.md)  /  [Working with databases](database.md) / DatabaseColumnText

[![Previous](previous.png)](databasecolumnsize.md) 
[![Next](next.png)](databasecolumninteger.md)
