...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiOsMA

[![Previous](previous.png)](cimomentumtype.md) 
[![Next](next.png)](ciosmafastemaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiOsMA |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [FastEmaPeriod](ciosmafastemaperiod.md) | Returns the averaging period of the fast EMA |
| [SlowEmaPeriod](ciosmaslowemaperiod.md) | Returns the averaging period of the slow EMA |
| [SignalPeriod](ciosmasignalperiod.md) | Returns the averaging period of the signal line |
| [Applied](ciosmaapplied.md) | Returns the price type or handle to apply |
| Create |  |
| [Create](ciosmacreate.md) | Creates the indicator |
| Data Access |  |
| [Main](ciosmamain.md) | Returns the buffer element |
| Input/output |  |
| virtual [Type](ciosmatype.md) | Virtual identification method |
