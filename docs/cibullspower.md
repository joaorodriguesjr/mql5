...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Oscillators](oscillatorindicators.md) / CiBullsPower

[![Previous](previous.png)](cibearspowertype.md) 
[![Next](next.png)](cibullspowermaperiod.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    [CIndicator](cindicator.md)                        CiBullsPower |

Class Methods by Groups

| Attributes |  |
| --- | --- |
| [MaPeriod](cibullspowermaperiod.md) | Returns the averaging period |
| Create |  |
| [Create](cibullspowercreate.md) | Creates the indicator |
| Data Access |  |
| [Main](cibullspowermain.md) | Returns the buffer element |
| Input/output |  |
| virtual [Type](cibullspowertype.md) | Virtual identification method |
