...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Indicators](technicalindicators.md)  /  [Timeseries classes](timeseries.md) / CiTickVolume

[![Previous](previous.png)](citimerefresh.md) 
[![Next](next.png)](citickvolumecreate.md)
...
|  |
| --- |
| Inheritance hierarchy    [CObject](cobject.md)        [CArray](carray.md)            [CArrayObj](carrayobj.md)                [CSeries](cseries.md)                    CiTickVolume |

Class Methods by Groups

| Create |  |
| --- | --- |
| [Create](citickvolumecreate.md) | Creates a timeseries |
| [BufferResize](citickvolumebufferresize.md) | Sets buffer sizes |
| Data Access |  |
| [GetData](citickvolumegetdata.md) | Gets the series data |
| Data Update |  |
| [Refresh](citickvolumerefresh.md) | Updates the series data |
