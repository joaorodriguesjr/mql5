...
[MQL5 Reference](index.md)  /  [Standard Library](standardlibrary.md)  /  [Mathematics](mathematics.md)  /  [Statistics](stat.md) / Cauchy distribution

[![Previous](previous.png)](mathmomentslogistic.md) 
[![Next](next.png)](mathprobabilitydensitycauchy.md)
...
![pdf_cauchy_distribution](pdf_cauchy_distribution.png)
...
![DemoCauchyDistribution](democauchydistribution.png)
...
| --- | --- |
| [MathProbabilityDensityCauchy](mathprobabilitydensitycauchy.md) | Calculates the probability density function of the Cauchy distribution |
| [MathCumulativeDistributionCauchy](mathcumulativedistributioncauchy.md) | Calculates the value of the Cauchy probability distribution function |
| [MathQuantileCauchy](mathquantilecauchy.md) | Calculates the value of the inverse Cauchy distribution function for the specified probability |
| [MathRandomCauchy](mathrandomcauchy.md) | Generates a pseudorandom variable/array of pseudorandom variables distributed according to the Cauchy law |
| [MathMomentsCauchy](mathmomentscauchy.md) | Calculates the theoretical numerical values of the first 4 moments of the Cauchy distribution |
